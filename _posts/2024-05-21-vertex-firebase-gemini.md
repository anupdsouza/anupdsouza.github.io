...
date: 2024-05-21 09:50:00 +0530
image: "/images/posts/vertex-firebase-gemini/featured.jpg"
...
seo_description: "Learn how to create a powerful multimodal chatbot using Gemini API and Vertex AI for Firebase SDK on iOS. This comprehensive guide walks you through Firebase setup, chat service creation, and media integration for advanced AI-powered apps."
categories:
  - iOS
  - AI
tags:
...
![image](/images/posts/vertex-firebase-gemini/p18-1.png)

- Select an existing iOS+ project. If you don't have one, select `Add Project` or `Create a project`

![image](/images/posts/vertex-firebase-gemini/p18-2.png)

- Give your project a name & hit `Continue`

![image](/images/posts/vertex-firebase-gemini/p18-3.png)
...
![image](/images/posts/vertex-firebase-gemini/p18-16.png)

![image](/images/posts/vertex-firebase-gemini/p18-17.png)

- Close the `Upgrade Complete` dialog above & then click on `Enable APIs` in the `Build with the Gemini API` pane.

![image](/images/posts/vertex-firebase-gemini/p18-18.png)

- Then click `Continue` in step 3 to `Add Vertex AI SDK for Firebase`.

![image](/images/posts/vertex-firebase-gemini/p18-19.png)
...
![image](/images/posts/vertex-firebase-gemini/p18-20.png)

![image](/images/posts/vertex-firebase-gemini/p18-21.png)

- Click on the 3-vertical dots to Open the menu against your app. Then click on `Manage debug tokens`.

![image](/images/posts/vertex-firebase-gemini/p18-22.png)

![image](/images/posts/vertex-firebase-gemini/p18-23.png)

- Click `Add debug token`

![image](/images/posts/vertex-firebase-gemini/p18-24.png)

- Enter a name in the `My debug token` field, say, `Simulator`. For the `Value` we will get this from our iOS app.

![image](/images/posts/vertex-firebase-gemini/p18-25.png)

- Go back to your Xcode project & ensure that the `FirebaseAppCheck` framework is linked.

![image](/images/posts/vertex-firebase-gemini/p18-26.png)

- Switch to your `App.swift` file & add the following code to setup `AppCheckDebugProviderFactory`.

![image](/images/posts/vertex-firebase-gemini/p18-27.png)
...
![image](/images/posts/vertex-firebase-gemini/p18-32.png)

![image](/images/posts/vertex-firebase-gemini/p18-33.png)
...
![image](/images/posts/vertex-firebase-gemini/result.png)
