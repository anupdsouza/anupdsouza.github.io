...
image: "/images/posts/murder-mystery-game-with-gemini-swiftui/featured.jpg"
...
<p align="center" style="font-size: 0.85rem;">
  Photo by <a href="https://unsplash.com/@kamsinjkaneko?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Kamsin Kaneko</a> on <a href="https://unsplash.com/photos/yellow-diamond-sign-reads-embrace-the-mystery-on-pole-2F6IpJO2PHk?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
</p>
...
![image](/images/posts/murder-mystery-game-with-gemini-swiftui/murder-mystery-screens.png)
...
Isn't it great that you can just _tell_ AI what to work with and let its natural language processing capabilities take over?
...
This has worked well _so far_ & is all that it took to create a murder mystery game. The best part about this approach to use AI is that with each gameplay, you get to experience a different story which is exciting.

![image](/images/posts/murder-mystery-game-with-gemini-swiftui/murder-mystery-gameplay.gif)
